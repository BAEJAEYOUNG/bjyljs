...
var gSpCd   = "${resultData.spCd}";                                // 서비스 제공자 코드
var gCustId = "${resultData.custId}";                              // 고객사 코드
var gServId = "${resultData.servId}";                              // 서비스 코드
...
//     ksid.debug.printObj('jsonForm1', jsonForm1);
    ...
    params.code = "200";
    console.log('### userPayFinal > params', params);
...
function doPushRegView() {
    ...
    document.form1.action = "${pageContext.request.contextPath}/ksid/fidoservice/webpushreg";
...
<div class="contents-wrap">
    ...
    <left>
        <img src="${pageContext.request.contextPath}/static/image/siteci/ksid_simple.png" style="width:140px;margin-bottom:10px;" />
        &nbsp;&nbsp;
