...
function loadUserData(params) {
    ...
    // 서비스 가입정보 가져오기
    ksid.net.ajaxJqGrid(grid1, "${pageContext.request.contextPath}/ksid/userInfo/list", params);
    // 서비스 결제정보 가져오기
    ksid.net.ajaxJqGrid(grid2, "${pageContext.request.contextPath}/ksid/userInfo/listPay", params);
...
function doSearchUser() {
    ...
    if(ksid.form.validateForm("divInfo")) {
        ...
        ksid.net.ajax("${pageContext.request.contextPath}/ksid/userInfo/sel", params, function(result) {
...
function doPayCancel() {
    ...
    ksid.ui.confirm('선택하신 결제내역( ' + grid2.clickedRowData.servNm + '-'  + grid2.clickedRowData.payCancelableYn + ' ) 을 승인취소 하시겠습니까?', function() {
        ...
        if( ksid.form.validateForm('form1') ) {
            ...
            $("#form1").attr('action', '${pageContext.request.contextPath}/cnspaycancel/requestEx');
