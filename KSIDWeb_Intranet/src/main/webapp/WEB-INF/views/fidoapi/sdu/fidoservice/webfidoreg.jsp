...
<jsp:include page="${config.crosscertPath}/CrosscertToolkit.jsp"/>
...
function genResultValue(data) {
    console.log('genResultValue > data', data);
...
function doFidoReg() {
    var params = ksid.form.flushPanel('edit-panel');
    params.custUserNo = document.form1.custUserNo.value;
    ksid.net.ajax("${pageContext.request.contextPath}/devauth/mobileauth/userStatChkFree", params, function(rcvdata) {
        ...
        <div id="edit-panel" class="edit-panel" style="min-width:400px;height:65px;">
            ...
            <br />
                <dl>
                    ...
                    <dd>
                        <input type="text" maxlength="16" id="custUserNo" name="custUserNo" title="학번" class="style-input width110" readonly />
                    </dd>
                </dl>
                <dl>
