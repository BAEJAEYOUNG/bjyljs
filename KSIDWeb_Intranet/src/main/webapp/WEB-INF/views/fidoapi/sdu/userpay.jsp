...
function doPayReq() {
    ...
    if( $("#edit-panel input[name=custUserNo]").val().length < 4) {
        ...
        <div id="edit-panel" class="edit-panel" style="min-width:400px;height:65px;">
            ...
            <br />
                <dl>
                    ...
                    <dd>
                        <input type="text" command="onKeyDown()" maxlength="16" name="custUserNo" title="학번" class="style-input width130" readonly/>
                    </dd>
                </dl>
            </div>
        </div>
