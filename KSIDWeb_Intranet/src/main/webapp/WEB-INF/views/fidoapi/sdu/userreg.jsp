...
function doReg() {
    ...
    if( $("#edit-panel input[name=custUserNo]").val().trim().length < 4 ) {
                        ...
                        if(result.resultCd == "01") {
                            ksid.ui.confirm("지문 인증 서비스를 가입 하시겠습니까?", function() {
                                ksid.net.ajax("${pageContext.request.contextPath}/registration/user/reg", params, function(result) {
                                    console.log('/registration/user/reg > result', result);
...
function doPushRegView() {
    ...
    if( ksid.form.validateForm('edit-panel') ) {
        ...
        $("#form1").attr('action', '${pageContext.request.contextPath}/sdu/fidoservice/webpushreg');
        $("#form1").attr('target', 'requestReg');

        var regWin = ksid.ui.openWindow('', 'requestReg', 550, 360);
        $("#form1").submit();
        regWin.focus();
    }
}
...
<div class="contents-wrap">
    ...
    <div class="styleDlTable">
        ...
        <table style="width:99%">
            ...
            <tr>
                <td><img src="${pageContext.request.contextPath}/static/image/siteci/SDU_signature02.png" style="width:230px;margin-bottom:10px;" /></td>
            </tr>
        </table>
    </div>
    <br/>
...
<!--         <div id="edit-panel" class="edit-panel" style="min-width:400px;height:270px;"> -->
        ...
        <div id="edit-panel" class="edit-panel" style="min-width:200;width:device-width;height:auto;">
            ...
            <input type="hidden" name="custId" value="C000062" /> <!-- 고객사-열린사이버대학 -->
            <input type="hidden" name="servId" value="S00000060"/>
            <input type="hidden" name="payFinalUrl" value="sdu/userPayFinal"/>
            ...
            <table class="styleContentsTable" cellpadding="0" cellspacing="1" border="0" font-size="7px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span>
                                <input type="text" maxlength="6" name="authNo" title="인증번호" class="style-input" style="width:110" format="no" />&nbsp;&nbsp;<!--
                                --><button type="button" class="style-btn" auth="W" onclick="doAuthConfirm()" style="width:70px; height:14px;">인증 확인</button>&nbsp;&nbsp;<!--
                                --><input type="text" maxlength="6" name="timerText" title="타이머" value = "2분 0초" class="style-input" format="no" style="border:0px;background-color:#e2e2e2;color:black;width:50;" disabled />
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <a href = "${config.htmlPath}/useterms.html" target = "_blank"> [보기] </a>
                        </td>
                    </tr>
                </tbody>
