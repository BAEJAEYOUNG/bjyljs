...
function doUserInfoSearch() {
    ...
    if( $("#edit-panel input[name=userID]").val().trim().length < 4) {
        ...
        <div id="edit-panel" class="edit-panel" style="min-width:400px;height:65px;">
            ...
            <br />
                <dl>
                    ...
                    <dd>
                        <input type="text" command="onKeyDown()" maxlength="16" name="userID" title="학번" class="style-input width110" readonly />
                    </dd>
                </dl>
            </div>
        </div>
