...
function genResultValue(data) {
    ...
    if( data == 200 ) {
        ksid.net.ajax("${pageContext.request.contextPath}/devauth/mobileauth/mobileOsChgFree", params, function(result) {
...
<div class="contents-wrap">
            ...
            <br />
                <dl>
                    ...
                    <dd>
                        ...
                        <button type="button" class="style-btn" auth="W" onclick="doPhoneReg()" style="width:80px; height:14px;">인증 번호 요청</button>
                    </dd>
                </dl>
                <dl>
    ...
    <div class="button-bar" style="text-align:center;">
        <input type="text" id="random" name="random" class="style-input width150" style="font-size:16pt;width:320px;height:40px;text-align:center;" readonly/>
    </div>
    </br>
    <!--  button bar  -->
    <div class="button-bar" style="text-align:center;">
