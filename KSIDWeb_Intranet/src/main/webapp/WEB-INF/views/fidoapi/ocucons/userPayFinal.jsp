...
function doPushRegView() {
    ...
    document.form1.action = "${pageContext.request.contextPath}/ocucons/fidoservice/webpushreg";
...
<div class="contents-wrap">
    ...
    <left>
        <img src="${config.imagePath}/fidoapi/ocucons.png" style="margin-bottom:10px;" />
        &nbsp;&nbsp;
