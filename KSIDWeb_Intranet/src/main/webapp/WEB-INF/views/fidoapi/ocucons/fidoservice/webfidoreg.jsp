...
function genResultValue(data) {
    console.log('webfidoreg > genResultValue > data', data);
...
function doReg() {
    ...
    if( ksid.form.validateForm('edit-panel') ) {
        $("#form1").attr('action', '${pageContext.request.contextPath}/ocucons/userreg');
...
<div class="contents-wrap">
    ...
    <form id="form1" name="form1" method="post">
        ...
        <div id="edit-panel" class="edit-panel" style="min-width:400px;height:65px;">
            ...
            <input type="hidden" name="custId" value="" /> <!-- 고객사-OCU컨소시엄 -->
