...
function loadUserData(params) {
    ...
    // 서비스 가입정보 가져오기
    ksid.net.ajaxJqGrid(grid1, "${pageContext.request.contextPath}/ocucons/userInfo/list", params);
    // 서비스 결제정보 가져오기
    ksid.net.ajaxJqGrid(grid2, "${pageContext.request.contextPath}/ocucons/userInfo/listPay", params);
...
function doSearchUser() {
    ...
    if(ksid.form.validateForm("divInfo")) {
        ...
        ksid.net.ajax("${pageContext.request.contextPath}/ocucons/userInfo/sel", params, function(result) {
    ...
    <div class="styleDlTable">
        <table style="width:100%">
            ...
            <tr>
                ...
                <input id="mainTmId" type="text" maxlength="6" name="mainTimerText" title="메인타이머" value = "10분 0초" class="style-input width45" style="border: 0px;background-color: #e2e2e2;color:black" disabled />
