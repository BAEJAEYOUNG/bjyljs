...
function doQuery(resultMsg) {
    ...
    ksid.net.ajaxJqGrid(grid1
                      , "${pageContext.request.contextPath}/billing/req/billcustmo/list"
                      , params
                      , function(result) {

        CommonJs.setStatus(  ksid.string.replace( "월정액 고객사 청구서 목록 <strong>{0}</strong>건이 조회 되었습니다.", "{0}", result.resultData.length ) );
...
function doExcel() {
    ...
    var url = "${pageContext.request.contextPath}/billing/req/billcustmo/excel";
    var fileNm = "월정액고객사청구서";
    var params = ksid.form.flushPanel("search-panel");
...
function doExcel2() {
    ...
    var url = "${pageContext.request.contextPath}/billing/req/billcustmo/excel2";
    var fileNm = "월정액고객사청구서";
...
<div class="contents-wrap">
    ...
    <div class="location-wrap">
        <p class="location"><span class="btn_home"></span>&nbsp;> <span name="menu">청구관리</span> > <span name="menu">월정액 고객사 청구서</span></p>
    </div>
    ...
    <h3 class="style-title"><span name="title">월정액 고객사 청구서</span></h3>
<!--     <div class="style-title-wrap"> -->
<!--         <h3 class="style-title">월정액 고객사 청구서</h3> -->
<!--         <div class="button-bar"> -->
