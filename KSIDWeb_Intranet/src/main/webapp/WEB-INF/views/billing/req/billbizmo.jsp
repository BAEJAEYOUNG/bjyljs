...
function doQuery(resultMsg) {
    ...
    ksid.net.ajaxJqGrid(grid1
                      , "${pageContext.request.contextPath}/billing/req/billbizmo/list"
                      , params
                      , function(result) {

        CommonJs.setStatus(  ksid.string.replace( "월정액 법인 청구서 목록 <strong>{0}</strong>건이 조회 되었습니다.", "{0}", result.resultData.length ) );
...
function doExcel() {
    ...
    var url = "${pageContext.request.contextPath}/billing/req/billbizmo/excel";
    var fileNm = "월정액법인청구서";
    var params = ksid.form.flushPanel("search-panel");
...
function doExcel2() {
    ...
    var url = "${pageContext.request.contextPath}/billing/req/billbizmo/excel2";
    var fileNm = "월정액법인청구서";
...
<div class="contents-wrap">
    ...
    <div class="location-wrap">
        <p class="location"><span class="btn_home"></span>&nbsp;> <span name="menu">청구관리</span> > <span name="menu">월정액 법인 청구서</span></p>
    </div>
    ...
    <div class="fRight">
        <h3 class="style-title"><span name="title">월정액 법인 청구서</span></h3>
        <!-- grid -->
