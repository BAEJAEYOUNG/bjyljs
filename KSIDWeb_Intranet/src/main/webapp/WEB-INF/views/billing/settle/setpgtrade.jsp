...
function doQuery(resultMsg) {
    ...
    ksid.net.ajaxJqGrid(grid1
                      , "${pageContext.request.contextPath}/billing/settle/setpgtrade/list"
                      , params
                      , function(result) {

        CommonJs.setStatus(  ksid.string.replace( "PG 거래대사 내역 <strong>{0}</strong>건이 조회 되었습니다.", "{0}", result.resultData.length ) );
...
function doExcel() {
    ...
    var url = "${pageContext.request.contextPath}/billing/settle/setpgtrade/excel";
    var fileNm = "PG 거래대사 내역";
    var params = ksid.form.flushPanel("search-panel");
...
<div class="contents-wrap">
    ...
    <div class="location-wrap">
        <p class="location"><span class="btn_home"></span>&nbsp;> <span name="menu">정산관리</span> > <span name="menu">PG 거래대사 내역</span></p>
    </div>
    ...
    <div class="style-title-wrap">
        <h3 class="style-title">PG 거래대사 내역 데이터 목록</h3>
    </div>
    <!-- grid -->
