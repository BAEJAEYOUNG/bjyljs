...
$(document).ready(function() {
    document.form1.custUserNo.value = "2015001543";//"${param.custUserNo}".trim();
    document.form1.spCd.value   = "P0003";//"${param.spCd}";
    document.form1.custId.value = "C000018";//"${param.custId}";
    document.form1.servId.value = "S00000007";//"${param.servId}";
...
function doFidoReg() {
    ...
    if( ksid.form.validateForm('edit-panel') ) {
        $("#form1").attr('action', '${pageContext.request.contextPath}/fidoservice/webfidoreg');
