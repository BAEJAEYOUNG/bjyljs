...
/* 샘플페이지에 입력 해야 할 정보 */
// ANDROID App Key 정보
// var _APPKEY_ANDROID = 'FjwmADokKwE5LTs3FSY8KyYu8P7r8/61lIDwtfGllJU/BwEaAAoCHHl5eHN8emJ1cmp7YWJud2Jle3l7d3wvEXFifmRicnZicHptcmF+dwknByoqLywIOhYtMDMyDzE9LwElHhoKPxUdLRh+eA==';
...
//IOS App Key 정보
// var _APPKEY_IOS = 'FjwmADokKwE5LTs3FSY8KyYu8P7r8/61lIDwtfGllJU/BwEaAAoCHHl5eHN8emJ1cmp7YWJud2Jle3l7d3wvEXFifmRicnZicHptcmF+dwknByoqLywIOhYtMDMyDzE9LwElHhoKPxUdLRh+eA==';
...
function doReg() {
    ...
    if( ksid.form.validateForm('edit-panel') ) {
        ...
        $("#form1").attr('target', 'regFidoReg');

        var regWin = ksid.ui.openWindow('', 'regFidoReg', 550, 530);
        $("#form1").submit();
        regWin.focus();
    }
}
...
function doPayRequest() {
    ...
    if( ksid.form.validateForm('edit-panel') ) {
        ...
        $("#form1").attr('target', 'reqFidoReg');

        var regWin = ksid.ui.openWindow('', 'reqFidoReg', 616, 620);
        $("#form1").submit();
        regWin.focus();
    }
}
...
function doFidoReg() {
    ...
    ksid.net.ajax("${pageContext.request.contextPath}/devauth/mobileauth/userStatChk", params, function(rcvdata) {
        ...
        else if( rcvdata.rstParam.retValue == "08" || rcvdata.rstParam.retValue == "11" ) {
...
<div class="contents-wrap">
    ...
    <center>
        <font style="font-size:24px;"><strong>지문 인증 서비스 - 지문 등록</strong></font>
    </center>
    ...
    <div class="button-bar" style="text-align:center;">
     <font style="font-size:13px;color:blue;"><strong>※ 지문등록 실행 후 사용자 스마트폰의 알림(푸쉬) 메시지 확인 클릭 </strong></font>
    </div>
    ...
    <!--  button bar  -->
    <div class="button-bar" style="text-align:center;">
        <button type="button" class="style-btn" auth="W" onclick="doFidoReg()" style="width:140px; height:30px;">지문 등록</button>
    </div>
