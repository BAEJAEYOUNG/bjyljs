...
function doQueryPaging(resultMsg) {
    ...
    var url = "${pageContext.request.contextPath}/stat/custuser/list";
...
function doQueryCustUserPaging(resultMsg) {
    ...
    var url = "${pageContext.request.contextPath}/stat/custuser/userByCustList";
...
function doQueryUserServHis(resultMsg) {
    ...
    var url = "${pageContext.request.contextPath}/stat/custuser/servHisByUserList";
    ...
    var url = "${pageContext.request.contextPath}/stat/custuser/pgHisByUserList";
...
function doCustExcel() {
    ...
    var url = "${pageContext.request.contextPath}/stat/custuser/excelCust";
    var fileNm = "고객사";
    var params = ksid.form.flushPanel("search-panel");
...
function doUserExcel() {
    ...
    var url = "${pageContext.request.contextPath}/stat/custuser/excelUser";
