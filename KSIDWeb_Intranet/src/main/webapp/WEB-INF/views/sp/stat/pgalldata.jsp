...
//    colModel.push({ label:'서비스제공자', name:'spNm', format:'string', width:100});
    ...
    colModel.push({ label:'학번', name:'custUserNo', width:100});
    ...
    colModel.push({ label:'사용자명', name:'userNm', hidden:true});
...
function doQueryPaging(resultMsg) {
    ...
    ksid.net.ajaxJqGrid(grid1
                      , "${pageContext.request.contextPath}/sp/stat/pgalldata/list"
                      , params
                      , function(result) {
...
function doExcel() {
    ...
    var url = "${pageContext.request.contextPath}/sp/stat/pgalldata/excel";
    ...
    <div id="search-panel" class="search-panel">
        ...
        <div class="styleDlTable">
            ...
            <dl>
                ...
                <dt>서비스선택</dt>
                <dd>
                    <select name="servId" title="서비스선택" class="style-select width180" overall="전체" codeGroupCd="SERV_ID"></select>
                </dd>
                <dt>승인/취소 결과</dt>
                <dd>
                     <select name="rstResultCd" title="승인/취소 결과" class="style-select width110" overall="전체" codeGroupCd="PAY_RESULT" selected_value="SUCC"></select>
                </dd>
                <dt>결제수단</dt>
                <dd>
