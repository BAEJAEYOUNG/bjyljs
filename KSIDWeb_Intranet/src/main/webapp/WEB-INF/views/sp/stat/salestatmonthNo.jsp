 ...
 // search-panel 의 form name, value를 <k,v> 형태로 params 에 담는다.
    ...
    ksid.net.ajaxJqGrid(grid1
        ...
        if(result.resultCd == '00') {
            setGridHeader();
            CommonJs.setStatus(  ksid.string.replace( "월별 결제현황 목록 <strong>{0}</strong>건이 조회 되었습니다.", "{0}", result.resultData.length ) );
        }
...
<div class="contents-wrap">
    ...
    <div class="location-wrap">
        <p class="location"><span class="btn_home"></span>&nbsp;> <span name="menu">매출현황</span> > <span name="menu">월별 결제현황</span></p>
    </div>
    ...
    <h3 class="style-title"><span name="title">월별 결제현황 목록</span></h3>
    <!-- grid -->
