...
var gSpCd   = "${resultParam.spCd}";                                // 서비스 제공자 코드
var gCustId = "${resultParam.custId}";                              // 고객사 코드
var gServId = "${resultParam.servId}";                              // 서비스 코드
...
function doPushRegView() {
    ...
    document.form1.action = "${pageContext.request.contextPath}/fidoservice/webpushreg";
...
<div class="contents-wrap">
    ...
    <left>
        <img src="${pageContext.request.contextPath}/static/image/siteci/ocu_signiture_02.png" style="width:220px;margin-bottom:10px;" />
        &nbsp;&nbsp;
