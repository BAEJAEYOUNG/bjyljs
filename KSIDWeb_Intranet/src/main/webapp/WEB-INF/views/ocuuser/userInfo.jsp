...
function loadUserData(params) {
    ...
    // 서비스 가입정보 가져오기
    ksid.net.ajaxJqGrid(grid1, "${pageContext.request.contextPath}/ocuuser/userInfo/list", params);
    // 서비스 결제정보 가져오기
    ksid.net.ajaxJqGrid(grid2, "${pageContext.request.contextPath}/ocuuser/userInfo/listPay", params);
...
function doSearchUser() {
    ...
    if(ksid.form.validateForm("divInfo")) {
        ...
        ksid.net.ajax("${pageContext.request.contextPath}/ocuuser/userInfo/sel", params, function(result) {
