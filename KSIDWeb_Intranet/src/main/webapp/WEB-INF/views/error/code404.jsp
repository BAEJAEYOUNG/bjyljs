...
<!-- menuArea --><jsp:directive.include file="/view/include/menuArea.jsp" /><!-- mArea -->
...
<div class="errorbox">
	...
	<div class="error_txt">요청하신 페이지가 없습니다. </div>
...
<!-- footerArea --><jsp:include page="/view/include/footer.jsp" /><!-- footerArea -->
</body>
</html>