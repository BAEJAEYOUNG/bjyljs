...
//            months: ['Jan.', 'Feb.', 'Mar.', 'Apr.', 'May', 'June', 'July', 'Aug.', 'Sep.', 'Oct.', 'Nov.', 'Dec.']
    ...
    function _setDisabled(_button, _value) {
      ...
      console.log("_btnWidget.option('disabled')", _btnWidget.option('disabled'));
    ...
    $.widget("KidSysco.MonthPicker", {
        ...
        _decorateButtons: function() {
            ...
            console.log('_minDate && _curYear == _toYear(_minDate)', _minDate && _curYear == _toYear(_minDate));
            console.log('_maxDate && _curYear == _toYear(_maxDate)', _maxDate && _curYear == _toYear(_maxDate));

            console.log('_minDate', _minDate);
            console.log('_curYear', _curYear);
            console.log('_toYear(_minDate)', _toYear(_minDate));
            console.log('_maxDate', _maxDate);
            console.log('_toYear(_maxDate)', _toYear(_maxDate));
