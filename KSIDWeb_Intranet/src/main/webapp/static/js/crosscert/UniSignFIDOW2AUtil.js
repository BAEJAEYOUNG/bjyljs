...
var UniSignW2A = {
    Scheme : {
        iOS : "CCFIDOForOCU",
        Android : "crosscertForOCU"
    },

    Package : {
        Android : "com.crosscert.ocu"
    },

    DownloadURL : {
        iOS : "https://itunes.apple.com/kr/app/gong-in-injeungsenteo/id426081742?mt=8",
        Android : "market://details?id=com.crosscert.ocu"
    },
    ...
    esignWithShow : function(retURL, appkey, data, rtnParam, sidOption,
            sidValue) {
        if (_USUtil.OS.isAndroid()) {
            var intent = _USUtil.makeIntent(this.Scheme.Android, "esign",
                    "requestCode", "8", "retURL", retURL, "appkey", appkey,
...
var _USUtil = {
    ...
    makeIntent : function() {
        ...
        if (UniSignW2A.Scheme.Android === arguments[0]) {
            ...
            intentAttribute = intentAttribute
                    + "component="
                    + "com.crosscert.ocu/com.crosscert.ocu.fido.FidoActivity"
                    + ";";
