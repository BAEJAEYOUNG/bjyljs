...
var userStatChkUrl = mainDomainUrl + "/devauth/mobileauth/userStatChkMB";
...
<input type="hidden" name="custUserNo" value=""/>
    ...
    <button type="button" id='authTokenValidate' onclick="reqAuthTokenValidate();">FIDO Validate</button>
     <br />
     <br />
     <iframe name="iFrame_authToken_validate" id = 'iFrameauthToken' width="350px;" height="50px;"></iframe>
</form>
</body>
</html>