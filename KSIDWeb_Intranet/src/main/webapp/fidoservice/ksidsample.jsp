...
function doSvcCancel() {
    ...
    document.form1.action = mainDomainUrl + "/ksid/usercancel";
...
function doSvcSearch() {
    ...
    document.form1.action = mainDomainUrl + "/ksid/usersearch";
...
function doPhonePushReg() {
    ...
    document.form1.action = mainDomainUrl + "/ksid/fidoservice/webpushreg";
...
function doPhonePushChange() {
    ...
    document.form1.action = mainDomainUrl + "/ksid/fidoservice/webpushchg";
...
function doFidoReg() {
    ...
    document.form1.action = mainDomainUrl + "/ksid/fidoservice/webfidoreg";
...
function doFidoDereg() {
    ...
    document.form1.action = mainDomainUrl + "/ksid/fidoservice/webfidodereg";
...
function doFidoLogin() {
    ...
    window.open("about:blank", "ksidmainlogin");
    document.form1.action = mainDomainUrl + "/fidoservice/ksidmainlogin.jsp";
    document.form1.target = "ksidmainlogin";
    document.form1.submit();
    document.form1.action = "";
    document.form1.target = "";
}
