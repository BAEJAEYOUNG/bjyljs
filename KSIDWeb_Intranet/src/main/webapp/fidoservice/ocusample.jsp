...
function doSvcPay() {
    ...
    var url = mainDomainUrl + "/ocuuser/userpay2";
    document.form1.action = url;
...
function doSvcCancel() {
    ...
    document.form1.action = mainDomainUrl + "/ocuuser/usercancel";;
...
function doSvcSearch() {
    ...
    document.form1.action = mainDomainUrl + "/ocuuser/usersearch2";
...
function doPhonePushReg() {
    ...
    document.form1.action = mainDomainUrl + "/fidoservice/webpushreg";
...
function doPhonePushChange() {
    ...
    document.form1.action = mainDomainUrl + "/fidoservice/webpushchg";
...
function doFidoReg() {
    ...
    document.form1.action = mainDomainUrl + "/fidoservice/webfidoreg";
...
function doFidoDereg() {
    ...
    document.form1.action = mainDomainUrl + "/fidoservice/webfidodereg";
...
function doFidoLogin() {
    ...
    window.open("about:blank", "ocumainlogin");
    document.form1.action = mainDomainUrl + "/fidoservice/ocumainlogin.jsp";
    document.form1.target = "ocumainlogin";
    document.form1.submit();
    document.form1.action = "";
    document.form1.target = "";
}
