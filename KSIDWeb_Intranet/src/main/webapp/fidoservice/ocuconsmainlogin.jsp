...
<title>OCU컨소시엄 지문 인증 서비스 샘플</title>
...
// ANDROID App Key 정보 2017-08-21 변경
...
function doSvcPay() {
    ...
    var url = mainDomainUrl + "/ocucons/userpay";
...
function doSvcReg() {
    ...
    var url = mainDomainUrl + "/ocucons/userreg";
    document.form1.action = url;
