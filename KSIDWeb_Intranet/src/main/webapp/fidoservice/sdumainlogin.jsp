...
<script type="text/javascript" src="./crosscert/jquery/jquery.min-3.1.0.js"></script>
...
// 샘플페이지에 입력 해야 할 정보 - 실 상용시 변경 될수 있음
// ANDROID App Key 정보 2018-10-25 변경
...
var _APPKEY_ANDROID = 'FjwmADokKwE5LTs3FSY8KyYuiILi+oWulJaJjYS7fAQtNj08OidqGQcFDT8QABoWChUBfmF2cmRhe3F7d3tjcG5gf2JrcnRjbTAPcWF/d3VnYgFgYAg5ByMZLSh9Fh13LxQMODYbKGcdFgUxBHNu';
var _APPKEY_IOS     = 'FjwmADokKwE5LTs3FSY8KyYuiILi+oWulJaJjYS7fCwMAWAYAAoBLgECABAMCR1oc2Z3ZmVydGpneH92aHxjdHtjfmJqPwNjbGh4Z3VqYwtwYQQvCjl9YBAdHDRqOSsAIhoDMGsZNT57K3R+';
...
var userStatChkUrl = mainDomainUrl + "/devauth/mobileauth/userStatChkFree";
